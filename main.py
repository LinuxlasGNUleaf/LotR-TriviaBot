...
try:
    with open(lotr_config.DISCORD_TOKEN, "r") as tokenfile:
...
try:
    with open(lotr_config.REDDIT_TOKEN, "r") as tokenfile:
...
GOOGLE_CLIENT = google_client.GoogleClient(lotr_config, google_credentials)
